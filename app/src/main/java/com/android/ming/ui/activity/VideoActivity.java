...
import com.android.ming.presenter.VideoPresenter;
import com.android.ming.ui.adapter.CommentHeaderAdapter;
    ...
    public void onClick(View v) {
        if (v == mFace) {
            ...
            if (isFree || SPUtil.getInt(this, Consts.SP.VIP) > 0) {// 如果为免费视频或者已付费，即可观看
                startActivity(VideoplayAty.createIntent(this, video.getUrl(), false, isFree));
//                this.finish();
            } else {
                PayActivity.createInstance(VideoActivity.this, 1);
            }
        }
    }
